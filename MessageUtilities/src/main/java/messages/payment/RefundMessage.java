...
public class RefundMessage implements Serializable {
    ...
    public RefundMessage(String merchantBankAccount, String token, BigDecimal amount, String description) {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof RefundMessage)) {
            return false;
        }
        var other = (RefundMessage) object;
