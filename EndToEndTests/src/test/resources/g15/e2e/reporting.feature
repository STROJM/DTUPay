...
Feature: Reporting
  ...
  Scenario: Registered customer requests list of refunds
    Given a merchant and customer with a valid bank account number
    And the merchant and customer is registered in DTUPay
    And the customer has a previous refund from merchant of 100 kr
    When the customer requests a list of previous payments
    Then the list contains a refund to the customer from the merchant for 100 kr
